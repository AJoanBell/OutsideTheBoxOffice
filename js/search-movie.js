class SearchMovie extends React.Component {
        ...
        return(
            <form className="search-form" role="search" onSubmit={(e) => this.handleClickSearch(e)}>
                <div className="input-group add-on">
                    <input type="text" ref="query" className="form-control input-group" placeholder="Search movie titles" />
    ...
    // When user searches a movie, call searchMovie function in app.js
    handleClickSearch(e) {
        e.preventDefault();
